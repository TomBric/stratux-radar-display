...
sudo apt install libasound2-dev libasound2-doc python3-alsaaudio espeak-ng espeak-ng-data -y
sudo apt install python3-websockets python3-xmltodict python3-pydbus python3-luma.oled python3-numpy -y
sudo pip3 install pybluez py-espeak-ng ADS1x15-ADC --break-system-packages
